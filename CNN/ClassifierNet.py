...
def clf():
    ...
    clf_fcon1 = Dense(units=256, activation='relu', kernel_initializer='he_normal',
                      bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(clf_input)
    ...
    clf_fcon2 = Dense(units=719, activation='softmax', kernel_initializer='he_normal',
                      bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(clf_fcon1)
