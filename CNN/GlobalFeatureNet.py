...
def gfn():
    ...
    gfn_conv1 = Conv2D(filters=256, kernel_size=3, strides=2, padding='same', activation='relu',
                       kernel_initializer='he_normal', bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(gfn_input)
    ...
    gfn_conv2 = Conv2D(filters=256, kernel_size=3, strides=1, padding='same', activation='relu',
                       kernel_initializer='he_normal', bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(gfn_conv1)
    # gfn_conv2 = BatchNormalization()(gfn_conv2)

    # Convolutional Layer with 256 3x3 kernels with single stride and same padding
    gfn_conv3 = Conv2D(filters=256, kernel_size=3, strides=2, padding='same', activation='relu',
                       kernel_initializer='he_normal', bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(gfn_conv2)
    # gfn_conv3 = BatchNormalization()(gfn_conv3)

    # Convolutional Layer with 256 3x3 kernels with single stride and same padding
    gfn_conv4 = Conv2D(filters=256, kernel_size=3, strides=1, padding='same', activation='relu',
                       kernel_initializer='he_normal', bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(gfn_conv3)
    ...
    gfn_fcon1 = Dense(units=1024, activation='relu', kernel_initializer='he_normal',
                      bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(gfn_flttn)
    ...
    gfn_fcon2 = Dense(units=512, activation='relu', kernel_initializer='he_normal',
                      bias_initializer='he_normal', kernel_regularizer=regularizers.l2(0.001))(gfn_fcon1)
